module.exports = {
    ...
    async execute(message, args, Discord, client, fs) {
        let _message = client.msgs12[message.author.username].message;
        ...
        let embed = new Discord.MessageEmbed()
            .setColor('#e42643')
            .setTitle('日')
            .setURL('https://jisho.org/search/%E6%97%A5%23kanji')
            .setDescription('[ひ]')
            .setThumbnail('https://raw.githubusercontent.com/mistval/kanji_images/master/gifs/65e5.gif')
            .addFields(
                { name: 'English', value: 'Day' },
                        ...
                        message.channel.awaitMessages(m => m.author.id == message.author.id,
                            { max: 1, time: 30000 }).then(collected => {
                                ...
                                if (collected.first().content.toLowerCase()) {
                                    ...
                                    client.msgs12[message.author.username] = {
                                        message: mes
                                    }
                                    fs.writeFile("./Database/12.json", JSON.stringify(client.msgs12, null, 4), err => {
                                        if (err) throw err;
                                    })
